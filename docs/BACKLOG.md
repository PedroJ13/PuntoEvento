...
- [ ] QA Azure de render de imagen publica por `publicBlobUrl`.
...
2. QA: validar que `publicBlobUrl` renderiza despues del ajuste de Storage.
3. Backend API: implementar endpoints publicos por servicio.
